...
if (document.getElementById('levelTable')) {
    ...
    { level: 52, initialBalance: 900.00, volume: 0.90, targetProfitLoss: 90.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 1000.00, color: '#3498db' },
    { level: 51, initialBalance: 800.00, volume: 0.80, targetProfitLoss: 80.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 900.00, color: '#3498db' },
    { level: 50, initialBalance: 700.00, volume: 0.70, targetProfitLoss: 70.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 800.00, color: '#3498db' },
    { level: 49, initialBalance: 600.00, volume: 0.60, targetProfitLoss: 60.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 700.00, color: '#3498db' },
    { level: 48, initialBalance: 500.00, volume: 0.50, targetProfitLoss: 50.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 600.00, color: '#3498db' },
    { level: 47, initialBalance: 400.00, volume: 0.40, targetProfitLoss: 40.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 500.00, color: '#3498db' },
    { level: 46, initialBalance: 300.00, volume: 0.30, targetProfitLoss: 30.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 400.00, color: '#3498db' },
    { level: 45, initialBalance: 200.00, volume: 0.20, targetProfitLoss: 20.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 300.00, color: '#3498db' },
    { level: 44, initialBalance: 180.00, volume: 0.18, targetProfitLoss: 20.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 200.00, color: '#3498db' },
    { level: 43, initialBalance: 165.00, volume: 0.15, targetProfitLoss: 19.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 180.00, color: '#3498db' },
    { level: 42, initialBalance: 150.00, volume: 0.14, targetProfitLoss: 17.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 165.00, color: '#3498db' },
    { level: 41, initialBalance: 126.00, volume: 0.11, targetProfitLoss: 14.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 150.00, color: '#3498db' },
    { level: 40, initialBalance: 115.00, volume: 0.11, targetProfitLoss: 11.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 126.00, color: '#3498db' },
    { level: 39, initialBalance: 105.00, volume: 0.10, targetProfitLoss: 10.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 115.00, color: '#3498db' },
    { level: 38, initialBalance: 96.00, volume: 0.09, targetProfitLoss: 9.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 105.00, color: '#3498db' },
    { level: 37, initialBalance: 88.00, volume: 0.08, targetProfitLoss: 8.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 96.00, color: '#3498db' },
    { level: 36, initialBalance: 79.00, volume: 0.07, targetProfitLoss: 7.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 88.00, color: '#3498db' },
    { level: 35, initialBalance: 72.00, volume: 0.06, targetProfitLoss: 6.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 79.00, color: '#3498db' },
    { level: 34, initialBalance: 66.00, volume: 0.06, targetProfitLoss: 6.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 72.00, color: '#3498db' },
    { level: 33, initialBalance: 60.00, volume: 0.05, targetProfitLoss: 5.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 66.00, color: '#3498db' },
    { level: 32, initialBalance: 55.00, volume: 0.05, targetProfitLoss: 5.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 60.00, color: '#3498db' },
    { level: 31, initialBalance: 50.00, volume: 0.04, targetProfitLoss: 4.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 55.00, color: '#3498db' },
    { level: 30, initialBalance: 46.00, volume: 0.04, targetProfitLoss: 4.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 50.00, color: '#3498db' },
    { level: 29, initialBalance: 42.00, volume: 0.03, targetProfitLoss: 3.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 46.00, color: '#3498db' },
    { level: 28, initialBalance: 39.00, volume: 0.03, targetProfitLoss: 3.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 42.00, color: '#3498db' },
    { level: 27, initialBalance: 36.00, volume: 0.03, targetProfitLoss: 3.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 39.00, color: '#3498db' },
    { level: 26, initialBalance: 33.00, volume: 0.03, targetProfitLoss: 3.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 36.00, color: '#3498db' },
    { level: 25, initialBalance: 30.00, volume: 0.02, targetProfitLoss: 2.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 33.00, color: '#3498db' },
    { level: 24, initialBalance: 28.00, volume: 0.02, targetProfitLoss: 2.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 30.00, color: '#3498db' },
    { level: 23, initialBalance: 26.00, volume: 0.02, targetProfitLoss: 2.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 28.00, color: '#3498db' },
    { level: 22, initialBalance: 24.00, volume: 0.02, targetProfitLoss: 2.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 26.00, color: '#3498db' },
    { level: 21, initialBalance: 22.00, volume: 0.02, targetProfitLoss: 2.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 24.00, color: '#3498db' },
    { level: 20, initialBalance: 20.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 22.00, color: '#3498db' },
    { level: 19, initialBalance: 19.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 20.00, color: '#3498db' },
    { level: 18, initialBalance: 18.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 19.00, color: '#3498db' },
    { level: 17, initialBalance: 17.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 18.00, color: '#3498db' },
    { level: 16, initialBalance: 16.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 17.00, color: '#3498db' },
    { level: 15, initialBalance: 15.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 16.00, color: '#3498db' },
    { level: 14, initialBalance: 14.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 15.00, color: '#3498db' },
    { level: 13, initialBalance: 13.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 14.00, color: '#3498db' },
    { level: 12, initialBalance: 12.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 13.00, color: '#3498db' },
    { level: 11, initialBalance: 11.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 12.00, color: '#3498db' },
    { level: 10, initialBalance: 10.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 11.00, color: '#3498db' },
    { level: 9, initialBalance: 9.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1000.00, ifLoss: 0.00, nextLevelBalance: 10.00, color: '#3498db' },
    { level: 8, initialBalance: 8.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1.00, ifLoss: 0.00, nextLevelBalance: 9.00, color: '#3498db' },
    { level: 7, initialBalance: 7.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1.00, ifLoss: 0.00, nextLevelBalance: 8.00, color: '#3498db' },
    { level: 6, initialBalance: 6.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1.00, ifLoss: 0.00, nextLevelBalance: 7.00, color: '#2ecc78' },
    { level: 5, initialBalance: 5.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1.00, ifLoss: 0.00, nextLevelBalance: 6.00, color: '#2ecc78' },
    { level: 4, initialBalance: 4.00, volume: 0.01, targetProfitLoss: 1.00, ifProfit: 1.00, ifLoss: 0.00, nextLevelBalance: 5.00, color: '#2ecc78' },
